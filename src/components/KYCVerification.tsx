...
import { Check, X, Eye, Clock, AlertCircle, FileText, Image, User } from 'lucide-react';
    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-600 mt-1">Review and verify customer identity documents</p>
        </div>
            ...
            <tbody>
              {kycApplications.map((application) => (
                <tr key={application.id} className="border-b border-gray-100 hover:bg-gray-50">
                  <td className="py-3 px-4 text-sm font-medium text-gray-900">{application.id}</td>
                  ...
                  <td className="py-3 px-4 text-sm text-gray-900">{application.documentType}</td>
                  <td className="py-3 px-4 text-sm text-gray-500">{application.submittedDate}</td>
                  <td className="py-3 px-4">
                          ...
                          <div className="space-y-6">
                            ...
                            <div className="border rounded-lg p-4">
                              ...
                              <div className="grid grid-cols-2 gap-4">
                                <div>
                                  ...
                                  <p className="text-sm text-gray-900">{selectedApplication.personalInfo.fullName}</p>
                                </div>
                                <div>
                                  <label className="text-sm font-medium text-gray-600">Date of Birth</label>
                                  <p className="text-sm text-gray-900">{selectedApplication.personalInfo.dateOfBirth}</p>
                                </div>
                                <div>
                                ...
                                <div>
                                  ...
                                  <p className="text-sm text-gray-900">{selectedApplication.personalInfo.occupation}</p>
                                </div>
                                <div className="col-span-2">
                                  <label className="text-sm font-medium text-gray-600">Address</label>
                                  <p className="text-sm text-gray-900">{selectedApplication.personalInfo.address}</p>
                                </div>
                              </div>
                            </div>
                            ...
                            <div className="border rounded-lg p-4">
                              ...
                              <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-2">
                                  <label className="text-sm font-medium text-gray-600">ID Front</label>
                                  <img 
                                ...
                                <div className="space-y-2">
                                  <label className="text-sm font-medium text-gray-600">ID Back</label>
                                  <img 
                                ...
                                <div className="space-y-2">
                                  <label className="text-sm font-medium text-gray-600">Proof of Address</label>
                                  <img 
                                    src={selectedApplication.documents.proofOfAddress} 
                            ...
                            <div className="flex justify-end space-x-3 pt-4 border-t">
                              <Button
                                ...
                                onClick={() => handleReject(selectedApplication.id, reviewNotes)}
                              >
